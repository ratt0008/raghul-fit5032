  ...
  <div class="container">
    <header class="d-flex justify-content-center py-3">
      <ul class="nav nav-pills">
        ...
        <li class="nav-item">
          <router-link to="/AddBookFunction" class="nav-link" active-class="active">Add Book Function</router-link>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <router-link to="/GetAllBooks" class="nav-link" active-class="active">Get All Books</router-link>
        </li>
      </ul>
    </header>
  </div>
